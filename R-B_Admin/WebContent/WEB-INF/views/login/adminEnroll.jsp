	...
	<div id="wrapping1">
		<div id="wrapping2">
			...
			<section>
				<div id="section_left">
					<div id="left_mainNav">
						<h1 style="margin-left: 20px; position: absolute;">관리자 회원가입</h1>
					</div>
				...
				<div id="section_right">
					...
					<div id="right_whole">
						<div id="right_head">
							<h1 style="font-size: 35px; font-weight: 900; text-align: center;'">&nbsp;&nbsp;관리자 회원가입</h1>
						</div>
						<br>
						<div id="right_middle">
									...
									<tbody>
										<tr>
											...
											<td class="td_input"><input type="text"
												...
												<button type="button" onclick="check();">중복확인</button></td>
										</tr>
										<tr>
